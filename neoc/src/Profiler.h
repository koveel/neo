...
#define PROFILE_SCOPE(name) constexpr auto fixedName = ::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
																	::InstrumentationTimer timer##__LINE__(fixedName.Data)
